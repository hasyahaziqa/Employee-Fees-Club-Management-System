...
{
echo "<script>alert('Answer has valid in pdf format allowed');</script>";
}
else
{
...
<head>
    ...
    <title>E-Trust : Submit Task </title>
                    ...
                    <div class="card alert">
                        <div class="card-body">
                            <form name="" method="post" action="" enctype="multipart/form-data">
                                <?php
                                    $sid=$_GET['sid'];
$sql="SELECT grade.id,grade.grade,grade.detail,tblassigment.AssignmentNumber,tblassigment.AssignmenttTitle,tblassigment.SubmissionDate,tblassigment.AssignmentDescription,tblassigment.AssigmentMarks,tblassigment.AssignmentFile from tblassigment join grade on grade.id=tblassigment.Cid where tblassigment.ID=$sid";
$query = $dbh -> prepare($sql);
$query->execute();
...
{               ?>
  ...
  <th width="200"><strong>Task Title</strong></th>
...
<td><?php  echo htmlentities($row->AssignmenttTitle);?></td>
  ...
  <td colspan="3" style="text-align: center;"><a href="../staff/assignmentfile/<?php echo $row->AssignmentFile;?>" width="100" height="100" target="_blank"> <strong style="color: red">View Task Paper</strong></a></td>
...
<form method="post" name="submit" enctype="multipart/form-data">
    ...
    <td>
    <textarea  name="assdes" placeholder="Task Description" rows="12" cols="14" class="form-control wd-450" required="true"></textarea></td>
  </tr>
<tr>
    <th><strong>Upload Task File </strong></th>
    <td>
    <input type='file' name="ansfile" placeholder="File Task" rows="12" cols="14" class="form-control wd-450" required="true"></td>
  </tr>
    <tr align="center">
        <center></center>
...
<tr>
    <th><strong>View Submitted Task Paper </strong></th>
    <td colspan="3" style="text-align: center;"><a href="assignanswer/<?php echo $data->AnswerFile;?>" width="100" height="100" target="_blank"> <strong style="color: blue">View Task Paper</strong></a></td>
