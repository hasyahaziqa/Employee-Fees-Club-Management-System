...
<head>
    ...
    <title>E-Trust:  Manage Task</title>
...
$sql="SELECT grade.id,grade.grade,grade.detail,tblassigment.AssignmentNumber,tblassigment.AssignmenttTitle,tblassigment.SubmissionDate,tblassigment.CreationDate,tbluser.ID,tbluser.Fullname,tbluser.MobileNumber,tbluser.Email,tbluser.Cid,tbluser.RollNumber,tblassigment.ID as aid,tbluploadass.Marks from tblassigment join grade on grade.id=tblassigment.Cid join tbluser on tbluser.ID=tblassigment.Tid join tbluploadass on tbluploadass.AssId=tblassigment.ID where tblassigment.Cid=$cid";
...
{               ?>
                     ...
                     <td><?php echo "Unchecked Task"; ?></td>
<?php } else { ?>
                                        <td>
                                            <span class="badge badge-primary"><?php  echo "Checked Task";?></span>
                                        </td>
<?php } ?> 
