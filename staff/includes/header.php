<div class="header">
        ...
        <div class="pull-left">
            <div class="logo"><a href="dashboard.php"><!-- <img src="../assets/images/logo.png" alt="" /> --><span>E-TRUST STAFF</span></a></div>
                ...
                <li class="header-icon dib"><i class="ti-email"></i>
                    <div class="drop-down">
                        <div class="dropdown-content-heading">
                            <span class="text-left"><?php echo $uploadedassign;?> New Task Uploaded</span>
                                ...
                                <li class="notification-unread">
                                    <a href="submit-assignment.php?assinid=<?php echo $row->AssId;?>&&uid=<?php echo $row->UserID;?>">
                                        ...
                                        <div class="notification-content">
                                            ...
                                            <div class="notification-text">Uploaded Task </div>
                                        </div>
                                    </a>
                                </li>
