...
<head>
    ...
    <title>E-Trust: Checked Task</title>
...
$sql="SELECT grade.id,grade.grade,grade.detail,tblassigment.AssignmentNumber,tbluser.ID,tbluser.Fullname,tbluser.RollNumber,tblassigment.AssignmenttTitle,tblassigment.SubmissionDate,tblassigment.CreationDate,tblassigment.ID as aid,tbluploadass.Marks from tblassigment join grade on grade.id=tblassigment.Cid join tbluser on tbluser.ID=tblassigment.Tid join tbluploadass on tbluploadass.AssId=tblassigment.ID where tblassigment.Tid=$tid"; 
