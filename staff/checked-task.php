            ...
            <div class="container-fluid">
                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Task Information</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <div id="main-content">
                    <div class="card alert">
                        <div class="card-body">
                            <form name="" method="post" action="checked-task-emp.php" enctype="multipart/form-data">
...
$sql="SELECT tblsubject.SubjectFullname,tblsubject.ID as subid from tblsubject 
...
{               ?>
            <option value="<?php  echo htmlentities($row->subid);?>"><?php  echo htmlentities($row->SubjectFullname);?></option><?php $cnt=$cnt+1;}} ?>
        </select>
                                        </div>
                                    </div>
                                </div>
