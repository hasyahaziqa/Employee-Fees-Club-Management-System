...
<head>
    ...
    <title>E-Trust Staff : Dashboard</title>
...
$sql ="SELECT * from  student where grade=:cid ";
...
?>
                                        <h4 style="color: blue">Total Club Member</h4>
                                        <h4 style="color: blue"><?php echo htmlentities($totuser);?></h4>
                                        <a href="reg-clubwiseusers.php"><h5>View Detail</h5></a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
$sql ="SELECT grade.id,grade.grade,grade.detail,tblassigment.AssignmentNumber,tblassigment.AssignmenttTitle,tblassigment.SubmissionDate from tblassigment join grade on grade.id=tblassigment.Cid where tblassigment.Tid=:tid";
$query = $dbh -> prepare($sql);
...
?>
                                        <h4 style="color: blue">Total Task</h4>
                                         <h4 style="color: blue"><?php echo htmlentities($totassign);?></h4>
                                         <a href="managetask.php"><h5>View Detail</h5></a>
                                    </div>
                                </div>
                            </div>
                        </div>
