...
$query->bindParam(':file',$file,PDO::PARAM_STR);
 ...
 $query->execute();
   ...
   if ($LastInsertId>0) {
    echo '<script>alert("New task has been added.")</script>';
                                ...
                                <div class="col-md-6">
                                    <div class="basic-form">
                                        <div class="form-group image-type">
                                            <label>Task File  <span>(if any)</span></label>
                                            <input type="file" name="assfile" accept="file/*">
                                        </div>
                                    </div>
                                </div>
                            </div>
