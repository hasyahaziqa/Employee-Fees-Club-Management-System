...
<head>
    ...
    <title>E-Trust Staff: Subject Wise Report </title>
            ...
            <div class="container-fluid">
                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Club Wise Report Information</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <div id="main-content">
                    <div class="card alert">
                        <div class="card-body">
                            <form name="" method="post" action="report.php" enctype="multipart/form-data">
                            <div class="card-header m-b-20">
                                <h4>Between Dates Report of uploaded Task</h4>
...
$sql="SELECT grade.id as id,grade.grade from grade"; 
...
{               ?>
            <option value="<?php  echo htmlentities($row->id);?>"><?php  echo htmlentities($row->grade);?></option><?php $cnt=$cnt+1;}} ?>
        </select>
                                        </div>
                                    </div>
                                </div>
