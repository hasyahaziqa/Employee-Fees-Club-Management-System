...
$sql="SELECT grade.id,grade.grade,grade.detail, student.id,student.sname,student.contact,student.ic,student.grade,student.sector_code,student.grade,student.fees,student.balance,student.membership,student.creationdate from student join grade on grade.id=student.grade where student.grade=$cid";
