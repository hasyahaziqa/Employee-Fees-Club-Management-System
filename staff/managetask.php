...
$sql="SELECT grade.id,grade.grade,tblassigment.AssignmentNumber,tblassigment.AssignmenttTitle,tblassigment.AssignmentDescription,tblassigment.SubmissionDate,tblassigment.ID as aid from tblassigment join grade on grade.id=tblassigment.Cid  where tblassigment.Tid=$tid LIMIT $offset, $no_of_records_per_page";
...
{               ?>
                                                <tr>
                                                    ...
                                                    <td><a href="edit-task.php?editid=<?php echo htmlentities ($row->aid);?>">Edit Details</a></td>
                                                </tr>                                             
                                              <?php $cnt=$cnt+1;}} ?> 
                                            </tbody>
                                        </table>
