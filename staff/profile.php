...
<head>
    ...
    <title>E-Trust : Staff Details</title>
...
$sql="SELECT grade.id,grade.grade,grade.detail,tblteacher.ID,tblteacher.EmpID,tblteacher.FirstName,tblteacher.LastName,tblteacher.MobileNumber,tblteacher.Email,tblteacher.Gender,tblteacher.Dob,tblteacher.CourseID,tblteacher.Religion,tblteacher.Address,tblteacher.Password,tblteacher.ProfilePic,tblteacher.JoiningDate from tblteacher join grade on grade.id=tblteacher.CourseID where tblteacher.ID=$tid";
...
<img class="img-responsive" src="../images/<?php  echo htmlentities($row->ProfilePic);?>" alt="" width="200" height="200"/> 
 </div>
</div>
 <div class="col-lg-8">
...
<div class="email-content">
<span class="contact-title">Club</span>
<span class="contact-email"><?php  echo htmlentities($row->grade);?></span>
</div>
 <div class="email-content">
