                    ...
                    <div class="card alert">
                        <div class="card-body">
                            <form name="" method="post" action="" enctype="multipart/form-data">
                                <?php
                                    $eid=$_GET['editid'];
$sql="SELECT grade.id,grade.grade,grade.detail,tblassigment.AssignmentNumber,tblassigment.AssignmenttTitle,tblassigment.SubmissionDate,tblassigment.AssignmentDescription,tblassigment.AssignmentFile from tblassigment join grade on grade.id=tblassigment.Cid where tblassigment.ID=$eid";
$query = $dbh -> prepare($sql);
$query->execute();
...
{               ?>
                                ...
                                <div class="col-md-6">
                                    <div class="basic-form">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control border-none input-flat bg-ash" name="asstitle" required="true" value="<?php  echo htmlentities($row1->grade);?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                   ...
                                   <div class="basic-form">
                                        <div class="form-group image-type">
                                            <label>Task File if any <span>(150 X 150)</span></label>
