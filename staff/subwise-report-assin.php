...
$sql="SELECT grade.id,grade.grade,grade.detail,tblassigment.AssignmentNumber,tblassigment.AssignmenttTitle,tblassigment.ID as assinid,tblassigment.SubmissionDate,tblassigment.CreationDate,tblteacher.ID,tblteacher.FirstName,tblteacher.LastName,tbluploadass.UserID,tbluploadass.AssId,tbluploadass.AssDes,tbluploadass.AnswerFile,tbluploadass.SubmitDate,tbluploadass.Marks,tbluser.ID as uid, tbluser.FullName,tbluser.MobileNumber,tbluser.Email,tbluser.Cid,tbluser.RollNumber from tblassigment join grade on grade.id=tblassigment.Cid join tblteacher on tblteacher.ID=tblassigment.Tid join tbluploadass on tblassigment.ID=tbluploadass.AssId join tbluser on tbluploadass.UserID=tbluser.ID where date(tbluploadass.SubmitDate) between '$fdate' and '$tdate' && tblassigment.Tid=$tid && tblassigment.Sid=$sid LIMIT $offset, $no_of_records_per_page";
