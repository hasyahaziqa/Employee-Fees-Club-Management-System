<div class="header">
        <div class="pull-left">
            <div class="logo"><a href="dashboard.php"><!-- <img src="assets/images/logo.png" alt="" /> --><span>E-TRUST USER</span></a></div>
        ...
        <div class="pull-right p-r-15">
            <ul>
                            ...
                            <ul>
                                     ...
                                     <li>
                                        ...
                                        <div class="notification-content">
                                            <small class="notification-timestamp pull-right" style="color:red"></small>
                ...
                <li class="header-icon dib"><img class="avatar-img" src="../assets/images/avatar/images (1).png" alt="" /> <span class="user-avatar"><i class="ti-angle-down f-s-10"></i></span>
